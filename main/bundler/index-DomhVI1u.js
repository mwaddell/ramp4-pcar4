...
import "tiny-emitter";
import { F as S, n as o, S as x, o as g, p as A, q as c, L as w, b as E, d as C } from "./main-jAL3zpXY.js";
...
class R extends S {
  ...
  _parseConfig(e) {
    ...
    if (o(this.$vApp.$pinia).headerControls = t, !e || !e.root.children)
      return;
    o(this.$vApp.$pinia).multilineItems = e.multilineItems?.enabled ?? !0;
    const l = [1, 2, 3, 4, 5, 6];
    !e.multilineItems?.maxLines || !l.includes(e.multilineItems?.maxLines) ? o(this.$vApp.$pinia).maxLines = 3 : o(this.$vApp.$pinia).maxLines = e.multilineItems.maxLines, this.handlePanelWidths(["legend"]), this.handlePanelTeleports(["legend"]);
   ...
   */
  getLegend() {
    return o(this.$vApp.$pinia).children || [];
  }
  /**
   ...
   */
  _insertItem(e, t) {
    o(this.$vApp.$pinia).addItem({ item: e, parent: t });
  }
  /**
  ...
  _replaceItem(e, t) {
    o(this.$vApp.$pinia).replaceItem({ oldItem: e, newItem: t });
  }
...
class ue extends R {
  added() {
    this.$iApi.component("legend-nav-button", _), this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => b(import("./screen-CdCRJ8yk.js"))
          },
          style: {
            width: "350px"
          },
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && E(this.$vApp.$pinia).removeButton("legend"), this.$iApi.fixture.exists("mapnav") && C(this.$vApp.$pinia).removeItem("legend"), o().$reset(), this.$iApi.panel.remove("legend");
    };
  }
}
export {
