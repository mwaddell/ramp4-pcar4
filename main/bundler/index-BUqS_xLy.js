...
import { _ as H, d as L, F as K, G as X } from "./main-jAL3zpXY.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Djp4ff51.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-RN5q9Uyd.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Bao4tDQ0.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CJJ_NqCW.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CDHsRFEB.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D7qKeSsU.js")))
      }), s;
    }), n = (s) => {
