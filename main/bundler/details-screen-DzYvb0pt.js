import { defineComponent as G, ref as x, onMounted as ie, createElementBlock as a, openBlock as t, createElementVNode as _, normalizeClass as V, createCommentVNode as H, Fragment as Q, renderList as J, normalizeStyle as me, toDisplayString as D, computed as M, resolveDirective as q, withDirectives as A, withModifiers as pe, createVNode as le, onBeforeMount as K, watch as U, onBeforeUnmount as X, unref as w, createBlock as R, inject as ee, resolveDynamicComponent as ce, createTextVNode as ae, resolveComponent as $e, withCtx as de } from "vue";
import { _ as ne, e as te, Q as oe, L as Te, V as Ee, G as Y } from "./main-jAL3zpXY.js";
...
import { T as Me } from "./toggle-switch-control-DmRq6ZuU.js";
import "pinia";
import "screenfull";
...
const Ie = {
    ...
    return ie(() => {
      ...
      _("div", {
        ...
        i.value.length > 1 ? (t(), a("div", Ce, [
          (t(!0), a(Q, null, J(i.value.slice(0, 3).reverse(), ($, y) => (t(), a("div", {
  ...
  setup(d, { emit: b }) {
    ...
    return K(() => {
      ...
      return A((t(), a("div", {
        ...
        (t(!0), a(Q, null, J(p.results, (S, n) => (t(), a("div", {
...
}), Ze = { class: "inline font-bold" }, Qe = ["innerHTML"], We = /* @__PURE__ */ G({
  __name: "esri-default",
  props: {
    fixtureFields: {
      type: Object,
...
}), Ye = ["innerHTML"], Je = { key: 1 }, Ke = /* @__PURE__ */ G({
  __name: "html-default",
  props: {
    identifyData: {
      type: Object,
  ...
  setup(d) {
    ...
    }, null, 8, Ye)) : (t(), a("div", Je, D(w(b)("details.layers.results.empty")), 1));
  }
  ...
  setup(d) {
    ...
    return ie(() => {
      j.value.push(
        v.event.on(Y.LAYER_REMOVE, (s) => {
          const L = v.panel.get("details");
          k.uid === s.uid && L && L.close();
        })
      ), j.value.push(
        v.event.on(Y.PANEL_CLOSED, (s) => {
          s.id === "details" && _e();
        })
      ), j.value.push(
        v.event.on(Y.PANEL_MINIMIZED, (s) => {
          s.id === "details" && be();
        })
      ), j.value.push(
        v.event.on(Y.MAP_BASEMAPCHANGE, (s) => {
        ...
        l.value ? (t(), a("div", kt, [
          h().length > 0 ? (t(), a("div", xt, [
            e.value ? A((t(), a("div", {
              ...
              (t(!0), a(Q, null, J(h().slice(u.value, g.value), (W, ue) => A((t(), a("button", {
