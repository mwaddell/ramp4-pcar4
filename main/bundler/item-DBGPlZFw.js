import { defineComponent as X, ref as E, onMounted as ye, resolveDirective as N, createElementBlock as a, openBlock as l, withModifiers as p, withDirectives as k, createElementVNode as o, unref as t, normalizeClass as w, withKeys as ce, inject as ue, computed as G, toRaw as C, resolveComponent as ve, createBlock as A, withCtx as ge, createTextVNode as V, toDisplayString as x, createCommentVNode as u, Fragment as oe, renderList as se, normalizeStyle as ke, useTemplateRef as xe, watch as we, createStaticVNode as me, resolveDynamicComponent as Me } from "vue";
import { p as Ce, o as y, a as Ie, a1 as I, G as Q, _ as ie, Q as Te, n as Se, a3 as U, a4 as b, S as ze, a5 as O, a6 as ne } from "./main-jAL3zpXY.js";
import "pinia";
...
const Ae = ["type", "aria-label", "checked", "disabled", "content"], ae = /* @__PURE__ */ X({
  __name: "checkbox",
  props: {
    value: {
      type: Object,
  ...
  setup(e) {
    ...
    const f = () => {
      i.value instanceof Ce ? i.legendItem.toggleVisibility() : i.legendItem instanceof y && (i.legendItem.clickSymbology(i.value.uid, !i.value.lastVisbility), c.value = !0);
    };
    return ($, s) => {
      const B = N("tippy");
      return l(), a("div", {
        ...
        k(o("input", {
          ...
          onClick: s[0] || (s[0] = p((Z) => f(), ["stop"])),
          checked: e.checked && c.value,
          onKeypress: s[1] || (s[1] = ce(p(() => {
          }, ["prevent"]), ["enter"])),
          onKeyup: s[2] || (s[2] = ce(p((Z) => f(), ["stop"]), ["enter"])),
          class: w([[
...
}), Ve = ["aria-label"], $e = ["aria-label"], Be = ["aria-label"], Ze = ["aria-label"], Ue = ["aria-label"], Ge = ["aria-label"], Re = ["content", "aria-label"], Pe = /* @__PURE__ */ X({
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = E(), $ = E(!1), s = Ie(), B = E(s.mobileView), Z = T, q = E(0), v = e, J = () => {
      ...
      R.value && C(v.legendItem.layer).reload().then(() => {
        q.value += 1, g.pointerType !== "mouse" && Z("focusItem");
      });
    ...
    return (g, m) => {
      const j = ve("dropdown-menu"), P = N("tippy");
      return l(), a("div", {
        onClick: m[3] || (m[3] = p(() => {
        }, ["stop"])),
...
}, Ne = ["innerHTML"], qe = ["src"], Fe = {
  key: 1,
  class: "symbologyIcon w-32 h-32"
}, Ke = ["innerHTML"], We = ["src"], Qe = {
  key: 1,
  ...
  setup(e) {
    ...
    return ye(() => {
    ...
    }), (c, f) => e.visible ? (l(), a("div", Qe, f[0] || (f[0] = [
      o("svg", {
      ...
      i.value.length > 1 ? (l(), a("div", Oe, [
        (l(!0), a(oe, null, se(i.value.slice(0, 3).reverse(), ($, s) => (l(), a("div", {
          ...
          }, null, 8, Ne)) : i.value[s].imgUrl ? (l(), a("img", {
            key: 1,
            class: "symbologyIcon w-28 h-28",
...
}), Je = /* @__PURE__ */ ie(Xe, [["__scopeId", "data-v-34dfeccd"]]), Ye = { class: "relative" }, _e = ["content"], et = {
  key: 0,
  ...
  key: 8,
  class: "relative"
}, It = ["content", "aria-label"], bt = { class: "flex p-5" }, ft = {
  key: 0,
  ...
  setup(e) {
    const T = Te(), i = Ie(), { t: c } = re(), f = ue("iApi"), $ = E(), s = e, B = Se(), Z = B.multilineItems, q = (s.legendItem instanceof y && s.legendItem.maxLines) ?? B.maxLines, v = E(i.mobileView), J = G(() => T.layerConfigs), H = E([]), F = E(!1), D = E(!1), K = xe("legendFocusItem"), Y = G(() => s.legendItem instanceof y ? C(s.legendItem.layer)?.layerType : ""), _ = G(() => s.legendItem instanceof y && C(s.legendItem.layer)?.canModifyLayer), R = G(() => {
      if (s.legendItem instanceof y) {
        const r = C(s.legendItem.layer);
        return r ? r.canReload : !0;
      } else
        return !1;
    }), ee = G(() => f.animate), M = G(() => s.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    s.legendItem instanceof y && C(s.legendItem.layer)?.sublayers.length > 0), g = (r) => r === U.Expand || r === U.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), m = (r) => He(r), j = () => {
      s.legendItem.children.length === 0 || !g(U.Expand) || (s.legendItem.toggleExpanded(), f.updateAlert(c(`legend.alert.group${s.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, P = () => {
      if (g(I.Symbology)) {
      ...
      g(I.Datatable) && W() && f.event.emit(Q.GRID_TOGGLE, s.legendItem.layer);
    }, te = (r) => {
      ...
      if (r.type === b.Error) {
        ...
        const h = setInterval(() => {
          const L = r.layer;
          (L && (L.layerExists || L.initiationState === ne.NEW || L.initiationState === ne.TERMINATING || L.initiationState === ne.TERMINATED) || n > 1200) && (clearInterval(h), L && f.geo.map.removeLayer(L), T.removeLayerConfig(r.layerId), f.fixture.get("legend")?.removeLayerItem(r.layerId)), n++;
        }, 250);
      } else {
        s.legendItem.error();
        const h = setInterval(() => {
          const L = r.parentLayerId || r.layerId, S = f.geo.layer.getLayer(L);
          S && (clearInterval(h), S.cancelLoad(), (f.fixture.get("legend")?.getLayerBoundItems(S) || []).forEach((d) => d.error())), n > 1200 && clearInterval(h), n++;
        }, 50);
      }
    }, de = () => {
    ...
    return s.legendItem instanceof y && (de(), we(
      ...
      const h = ve("item", !0), L = N("tippy"), S = N("truncate"), le = N("focus-item");
        ...
        o("div", Ye, [
          k((l(), a("div", {
            class: w(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              M.value && g(t(U).Expand) || !M.value && e.legendItem instanceof t(y) && g(t(I).Datatable) && W() && e.legendItem.type === t(b).Item ? "cursor-pointer" : "cursor-default",
            ...
            onClick: n[12] || (n[12] = () => {
              !M.value && e.legendItem instanceof t(y) && g(t(I).Datatable) && W() && e.legendItem.type === t(b).Item ? z() : M.value && j();
            }),
            content: M.value && g(t(U).Expand) ? t(c)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(y) && e.legendItem.type === t(b).Item && g(t(I).Datatable) && W() ? t(c)("legend.layer.data") : "",
            "truncate-trigger": "",
            ref_key: "legendFocusItem",
            ref: K
          }, [
            e.legendItem.type !== t(b).Item ? (l(), a("div", et, [
              e.legendItem.type === t(b).Placeholder ? (l(), a("svg", tt, n[14] || (n[14] = [
            ...
            e.legendItem instanceof t(y) && t(Z) ? k((l(), a("div", {
              key: 3,
              class: w(["flex-1 pointer-events-none m-5", `line-clamp-${t(q)}`])
            }, [
            ...
            e.legendItem.type === t(b).Error && R.value ? (l(), a("div", yt, [
              k((l(), a("button", {
                type: "button",
            ...
            (e.legendItem.type === t(b).Item || e.legendItem.type === t(b).Placeholder && t(Z)) && e.legendItem instanceof t(y) ? (l(), A(De, {
              key: 7,
              class: w({
            ...
            e.legendItem.type !== t(b).Item && e.legendItem instanceof t(y) ? (l(), a("div", vt, [
              k((l(), a("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
                ...
                o("div", bt, [
                  e.legendItem.type === t(b).Placeholder ? (l(), a("svg", ft, n[18] || (n[18] = [
            ...
            e.legendItem.type === t(b).Item && e.legendItem instanceof t(y) && e.legendItem.layerOffscale ? k((l(), a("div", {
              key: 9,
            ...
            e.legendItem.type === t(b).Item && e.legendItem instanceof t(y) && !e.legendItem.layer?.mapLayer ? k((l(), a("div", {
              key: 10,
              class: "relative p-4 cursor-default",
            ...
            e.legendItem.type === t(b).Item && e.legendItem instanceof t(y) && e.legendItem.layerOffscale ? (l(), a("div", kt, [
              k((l(), a("button", {
                type: "button",
                class: "p-4",
            ...
            ])) : e.legendItem.type === t(b).Item && g(t(U).Visibility) ? (l(), A(ae, {
              key: 12,
          ...
          e.legendItem.type === t(b).Placeholder || e.legendItem instanceof t(y) && e.legendItem.layerRedrawing && e.legendItem.visibility ? (l(), a("div", wt, n[23] || (n[23] = [
...
}), Sl = /* @__PURE__ */ ie(Nt, [["__scopeId", "data-v-ea22b3ac"]]);
export {
  Sl as default
};
