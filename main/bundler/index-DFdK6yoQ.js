...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-jAL3zpXY.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CJJ_NqCW.js"), "./icons/edit-icon.vue": () => import("./edit-icon-D7qKeSsU.js"), "./icons/point-icon.vue": () => import("./point-icon-Djp4ff51.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Bao4tDQ0.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-RN5q9Uyd.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CDHsRFEB.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
