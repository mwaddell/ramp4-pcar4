...
import { ref as f, computed as P, markRaw as Q, defineComponent as O, inject as ge, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, createElementBlock as A, openBlock as v, withKeys as ps, withModifiers as Qt, onMounted as Ke, normalizeStyle as Mi, normalizeClass as ie, createVNode as ne, Transition as Pi, withCtx as se, createBlock as W, resolveDynamicComponent as ds, mergeProps as hs, useCssVars as fs, TransitionGroup as Ni, Fragment as Ye, renderList as ht, unref as I, nextTick as Ot, renderSlot as Me, createElementVNode as m, vShow as ms, resolveComponent as Z, createTextVNode as nt, toDisplayString as U, createCommentVNode as V, onUpdated as ys, Teleport as gs, getCurrentInstance as vs, useTemplateRef as mi, createApp as Fi, toRaw as Ie, h as bs, render as Bt, defineAsyncComponent as ws } from "vue";
...
import le from "proj4";
import { debounce as Tt, throttle as st } from "throttle-debounce";
...
import it from "svg.js";
import Ui from "animejs";
import "tippy.js/animations/scale.css";
var Ce = /* @__PURE__ */ ((s) => (s.BLOB = "blob", s.DATE = "date", s.DOUBLE = "double", s.GEOMETRY = "geometry", s.GLOBAL_ID = "global-id", s.GUID = "guid", s.INTEGER = "integer", s.LONG = "long", s.OID = "oid", s.RASTER = "raster", s.SINGLE = "single", s.SMALL_INTEGER = "small-integer", s.STRING = "string", s.XML = "xml", s))(Ce || {}), $e = /* @__PURE__ */ ((s) => (s.CIRCLE = "circle", s.CROSS = "cross", s.DIAMOND = "diamond", s.ICON = "icon", s.PATH = "path", s.SQUARE = "square", s.TRIANGLE = "triangle", s.X = "x", s))($e || {}), ce = /* @__PURE__ */ ((s) => (s.DASH = "dash", s.DASHDOT = "dash-dot", s.DASHDOTDOT = "short-dash-dot-dot", s.DOT = "dot", s.LONGDASH = "long-dash", s.LONGDASHDOT = "long-dash-dot", s.LONGDASHDOTDOT = "long-dash-dot-dot", s.NONE = "none", s.NULL = "none", s.SHORTDASH = "short-dash", s.SHORTDASHDOT = "short-dash-dot", s.SHORTDASHDOTDOT = "short-dash-dot-dot", s.SHORTDOT = "short-dot", s.SOLID = "solid", s))(ce || {}), Vi = /* @__PURE__ */ ((s) => (s.BEVEL = "bevel", s.MITER = "miter", s.ROUND = "round", s))(Vi || {}), Bi = /* @__PURE__ */ ((s) => (s.ROUND = "round", s.BUTT = "butt", s.SQUARE = "square", s))(Bi || {}), zi = /* @__PURE__ */ ((s) => (s.BDIAG = "backward-diagonal", s.CROSS = "cross", s.DIAG_CROSS = "diagonal-cross", s.FDIAG = "forward-diagonal", s.HORIZONTAL = "horizontal", s.NONE = "none", s.NULL = "none", s.SOLID = "solid", s.VERTICAL = "vertical", s))(zi || {}), L = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s.LINEARRING = "LinearRing", s.EXTENT = "Extent", s.NONE = "None", s.UNKNOWN = "Unknown", s))(L || {}), kt = /* @__PURE__ */ ((s) => (s.Simple = "simple", s.Unique = "uniqueValue", s.ClassBreaks = "classBreaks", s.Unknown = "unknown", s))(kt || {}), x = /* @__PURE__ */ ((s) => (s.FEATURE = "esri-feature", s.MAPIMAGE = "esri-map-image", s.TILE = "esri-tile", s.IMAGERY = "esri-imagery", s.IMAGERYTILE = "esri-imagery-tile", s.GRAPHIC = "esri-graphic", s.WMS = "ogc-wms", s.WFS = "ogc-wfs", s.GEOJSON = "file-geojson", s.GEOJSONZIPPED = "file-zip-geojson", s.CSV = "file-csv", s.SHAPEFILE = "file-shape", s.FLATGEOBUF = "file-fgb", s.FLATGEOBUFZIPPED = "file-zip-fgb", s.OSM = "osm-tile", s.DATACSV = "data-csv", s.DATAJSON = "data-json", s.DATATABLE = "data-esri-table", s.UNKNOWN = "unknown", s.SUBLAYER = "sublayer", s))(x || {}), he = /* @__PURE__ */ ((s) => (s.FEATURE = "feature", s.GRAPHIC = "graphic", s.IMAGERY = "imagery", s.IMAGERYTILE = "imagery-tile", s.MAPIMAGE = "map-image", s.NOLAYER = "no-layer", s.OSM = "osm-tile", s.TILE = "tile", s.UNKNOWN = "unknown", s.WMS = "wms", s))(he || {}), ee = /* @__PURE__ */ ((s) => (s.ESRI_FEATURE = "esriFeature", s.ESRI_RASTER = "esriRaster", s.ESRI_TILE = "esriTile", s.OSM_TILE = "osmTile", s.OGC_RASTER = "ogcRaster", s.UNKNOWN = "unknown", s))(ee || {}), z = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s))(z || {}), X = /* @__PURE__ */ ((s) => (s.GEOMETRIC = "geometric", s.SYMBOLIC = "symbolic", s.HYBRID = "hybrid", s.NONE = "none", s))(X || {}), D = /* @__PURE__ */ ((s) => (s.NEW = "new", s.INITIATING = "initiating", s.INITIATED = "initiated", s.TERMINATING = "terminating", s.TERMINATED = "terminated", s))(D || {}), q = /* @__PURE__ */ ((s) => (s.NEW = "new", s.LOADING = "loading", s.LOADED = "loaded", s.ERROR = "error", s))(q || {}), ue = /* @__PURE__ */ ((s) => (s.NOT_LOADED = "not-loaded", s.NOT_VISUAL = "not-visual", s.REFRESH = "refresh", s.UP_TO_DATE = "up-to-date", s))(ue || {}), lt = /* @__PURE__ */ ((s) => (s.ESRI = "esri", s.TEXT = "text", s.IMAGE = "image", s.HTML = "html", s.XML = "xml", s.JSON = "json", s.UNKNOWN = "unknown", s))(lt || {}), ae = /* @__PURE__ */ ((s) => (s.SYMBOL = "symbol", s.GRID = "grid", s.EXTENT = "extent", s.INITIAL = "initial", s.API = "api", s.PERMANENT = "permanent", s))(ae || {}), j = /* @__PURE__ */ ((s) => (s.BoundaryZoom = "boundaryZoom", s.Datatable = "datatable", s.Identify = "identify", s.Metadata = "metadata", s.Opacity = "opacity", s.Refresh = "refresh", s.Reload = "reload", s.Remove = "remove", s.Settings = "settings", s.Symbology = "symbology", s.Visibility = "visibility", s))(j || {});
class Ee {
  attributes;
  geometry;
  style;
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = He.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class Ve extends de {
  ...
  static fromESRI(e, t) {
    return new Ve(t, e.paths[0], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Di({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Ve(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class ve extends Ze {
  ...
  getAt(e) {
    return new Ve(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class We extends de {
  constructor(e, t, i, r) {
    if (super(e, t, i, r), We.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new We(t, e.rings[0], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ei({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new We(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class oe extends Ze {
  ...
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = oe.arrayDeepCopy(t) : this.rawArray = oe.parsePolygon(t);
  }
  addLinearRings(e) {
  ...
  get ringArray() {
    return this.rawArray.map((e, t) => new We(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parsePolygon(e) {
    ...
    return t.forEach((i) => We.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
  ...
  static fromGeoJSON(e, t) {
    return new oe(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(z.POLYGON, this.toArray());
  }
...
class Oe extends Ze {
  ...
  get polygonArray() {
    return this.rawArray.map((e, t) => new oe(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof ve || e instanceof de)
      return [oe.parsePolygon(e)];
    if (Array.isArray(e)) {
      if (e.length === 0)
        throw new Error("no polygons provided");
      return e.map((t) => oe.parsePolygon(t));
    } else
...
class G extends Ze {
  ...
  toPolygon() {
    return new oe(this.id, this.toPolygonArray(), this.sr, !0);
  }
...
class Te extends ke {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Pe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Bi.ROUND, this._join = e.join || Vi.ROUND;
  }
...
class Gs {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Ve.fromESRI(i, t) : ve.fromESRI(i, t);
      }
      case "polygon":
        return oe.fromESRI(e, t);
      case "extent":
        return G.fromESRI(e, t);
      case "multipoint":
        return ct.fromESRI(e, t);
      default:
...
class Bs {
  espgWorker;
  constructor() {
    this.espgWorker = this.defaultEpsgLookup, le.defs(
      "EPSG:3978",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), le.defs(
      "EPSG:3979",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), le.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), le.defs("EPSG:102100", le.defs("EPSG:3857")), le.defs(
      "EPSG:102187",
    ...
    for (; e <= 60; ) {
      const t = e < 10 ? `0${e}` : e;
      le.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
    }
  }
  /**
   ...
   */
  addProjection(e, t) {
    e = typeof e == "number" ? `EPSG:${e}` : e, le.defs(e, t);
  }
  ...
  async checkProj(e) {
    ...
    const a = async (n) => {
      try {
        ...
        return c === null || c === "" ? !1 : (le.defs(n, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectGeoJson(e, t, i) {
    let r, a;
    if (t ? r = this.normalizeProj(t) : r = _.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = Vs, a === r)
      return e;
    await this.checkProjBomber([r, a]);
    const o = le(r, a).forward;
    return Rs(e, o);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = He.geom.geomGeoJsonToRamp(r, t.id);
  ...
  async projectExtent(e, t) {
    ...
    const o = new oe("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
class zs {
  ...
  sharedUtils;
  constructor() {
    this.proj = new Bs(), this.geom = new Gs(), this.sharedUtils = new Us();
  }
  defaultTileSchemas() {
...
const $t = B("appbar", () => {
  ...
  function i(o) {
    if (s.value = { ...s.value, [o.id]: Q(o) }, o.id in e.value)
      e.value[o.id].resolveMe(Q(o));
    else {
      const l = new H();
      l.resolveMe(Q(o)), e.value = {
        ...e.value,
        [o.id]: l
      };
    }
...
const er = ["data-cy"], Ji = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return v(), A("div", {
        class: ie(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", s.panel.expanded ? "flex-grow max-w-full" : ""]),
  ...
  function h(S) {
    const R = [];
    return S.forEach((fe) => {
      fe in l.value && R.push(l.value[fe].getPromise());
    }), R;
  }
  function y(S) {
    Nt(S), te(), e.value = void 0;
  }
  function w(S) {
    Ft(S), te();
  }
  ...
  function te() {
    let S = t.value;
    const R = [], fe = 350, et = 12, hi = 600;
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const tt = n.value[Fe];
      let Re = tt.width || fe;
      if (r.value ? Re = S : Re += et, tt.id === "grid" && (Re = Math.max(Math.min(Re, S), hi)), (S >= Re && !r.value || R.length === 0) && (S -= Re, R.unshift(tt)), tt.id === "grid" && S < hi)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(s.value) && !r.value) {
      let Fe;
      for (let fi = 0; fi < R.length - 1 && S < (s.value.width || fe) + et; fi++)
        Fe = R.shift(), S += Fe.width || fe;
      S >= (s.value.width || fe) ? R.unshift(s.value) : e.value || (Fe = R.shift(), R.unshift(s.value));
      const tt = n.value.indexOf(s.value), Re = n.value.indexOf(Fe), Vt = n.value.slice();
      Re > -1 && (Vt.splice(tt, 1), Vt.splice(Re, 0, s.value)), n.value = Vt;
    }
    i.value = S, u.value = R;
  }
  function Qe(S) {
  ...
  function Dt(S, R) {
    const fe = n.value.indexOf(S), et = R === "right" ? 1 : -1;
    u.value.includes(n.value[fe + et]) && ([n.value[fe], n.value[fe + et]] = [
      n.value[fe + et],
      n.value[fe]
    ]);
  }
  ...
  setup(s) {
    ...
    const e = Je(), t = ge("iApi"), i = f(), r = P(() => e.opacity), a = P(() => e.mobileView);
    Ke(() => {
    ...
    return (u, p) => (v(), W(Ni, {
      ...
      default: se(() => [
        (v(!0), A(Ye, null, ht(o(I(t).screenSize), (d) => (v(), W(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
    ...
    return Ke(() => {
      ...
      return v(), A("div", {
        ...
        M(m("div", {
          ...
          class: ie(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": s.centered }]),
          ref_key: "dropdown",
          ref: a
        }, [
          Me(p.$slots, "default", {
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return v(), W(l, { panel: s.panel }, {
        header: se(() => [
          nt(U(I(t)("notifications.title")), 1)
        ]),
        content: se(() => [
          m("div", rr, [
            m("div", ar, [
...
var me = /* @__PURE__ */ ((s) => (s.ERROR = "error", s.INFO = "info", s.WARNING = "warning", s))(me || {});
class lr extends J {
  notificationStore;
  /**
    ...
    return (n, c) => {
      ...
      return M((v(), A("li", {
        ...
        s.notification.messageList && r.value ? (v(), A("div", hr, [
          (v(!0), A(Ye, null, ht(s.notification.messageList, (p, d) => (v(), A("p", {
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          (v(!0), A(Ye, null, ht(o.value, (d, g) => (v(), A(Ye, {
            key: d.message + g
          }, [
            g > 0 ? (v(), A("div", yr)) : V("", !0),
            M(ne(fr, {
      ...
      return v(), W(ii, {
        ...
        header: se(() => [
          m("div", vr, [
            ...
            i.value && i.value > 0 ? (v(), A("span", wr, U(i.value), 1)) : V("", !0)
          ])
        ]),
        default: se((c) => [
          m("div", Ar, [
            ...
            ne(Zi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Gr = /* @__PURE__ */ Ne(Dr, [["__scopeId", "data-v-24f3a9dc"]]), Ur = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Vr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Br = ["href", "aria-label"], zr = ["src", "alt"], qr = {
  key: 1,
  ...
  setup(s) {
    ...
    return (w, b) => {
      ...
      return v(), A("div", Ur, [
        ...
        ne(_r, { class: "sm:block display-none" }),
        d() ? (v(), A("span", Vr, [
          m("a", {
        ...
        o.value?.text.disabled ? V("", !0) : M((v(), A("span", qr, [
          nt(U(o.value?.text.value), 1)
        ])), [
          [T, {
            options: {
              placement: "top",
        ...
        m("div", jr, [
          l.value?.disabled ? V("", !0) : M((v(), A("div", Wr, [
            nt(U(l.value?.formattedString), 1)
          ])), [
            [T, {
              options: {
                hideOnClick: !1,
          ...
          a.value?.disabled ? V("", !0) : M((v(), A("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? V("", !0) : (v(), W($, {
            ...
            default: se(() => [
              (v(!0), A(Ye, null, ht(u.value, (F, te) => (v(), A("a", {
                key: `${F}-${te}`,
                class: ie(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === I(r).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Qe) => g(F)
              }, [
                nt(U(I(i)("map.language." + F)) + " ", 1),
                F === I(r).$i18n.locale.value ? (v(), A("span", Zr, U(I(i)("map.language.curr")), 1)) : V("", !0)
              ], 10, Kr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return M((v(), A("button", {
        ...
        r.value && r.value > 0 ? (v(), A("span", ea, U(r.value), 1)) : V("", !0)
      ], 8, Qr)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          (v(!0), A(Ye, null, ht(r.value, (d) => (v(), A("p", {
...
}), rt = B("instance", () => ({ started: f(!1) })), oa = { class: "h-full relative" }, na = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, la = { class: "absolute top-8 w-full flex justify-center" }, ca = {
  key: 1,
  class: "w-full h-full"
}, ua = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    const e = ge("iApi"), t = rt(), i = ye(), r = Je(), { t: a } = Y(), o = P(() => i.items.appbar), l = () => {
    ...
    return (c, u) => (v(), A("div", oa, [
      m("div", na, [
        ...
        ne(aa, { class: "keyboard-instructions-modal" }),
        ne(ir, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? V("", !0) : (v(), W(ia, { key: 0 })),
        ne(Xr, { class: "z-30" })
      ]),
      I(t).started ? (v(), W(Xs, { key: 0 })) : (v(), A("div", ca, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), A(Ye, null, ht(n(), (p) => (v(), W(gs, {
...
}), pa = /* @__PURE__ */ Ne(ua, [["__scopeId", "data-v-3d441124"]]), da = O({
  name: "App",
  components: { Shell: pa },
  setup() {
    const s = vs();
...
const ya = /* @__PURE__ */ Ne(da, [["render", ma]]), Se = "focus-list", je = "focus-item", ga = "focus-icon", va = "focus-container", ut = `[${Se}],[${va}]`, wt = "truncate-text", At = "show-truncate", ot = "focused", Kt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${ga}],[tabIndex]`, ba = {
  mounted(s, e) {
...
function Xi(s) {
  s.querySelectorAll(Kt).forEach((t) => {
    if (t.closest(ut) === s || t.closest(ut) === t && t.parentElement.closest(ut) === s)
      if (t.closest(`[${Se}],.${ot}`).classList.contains(ot))
...
class wa {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Kt).forEach((r) => {
      (e === -1 || r.closest(ut) === this.element || r.closest(ut) === r && r.parentElement.closest(ut) === this.element || r.closest(`[${Se}],.${ot}`).classList.contains(ot)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === At && e.querySelector(`[${wt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === At && e.querySelector(`[${wt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      this.element.querySelectorAll(`[${je}]`),
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${je}]`) || t.closest(`[${Se}]`) || this.highlightedItem, t.hasAttribute(`${je}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${wt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Xi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${wt}]`)?._tippy?.hide());
  }
  /**
...
const Ca = ["content"], Oa = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Je(), r = $t(), a = ge("iApi"), o = mi("el"), l = mi("contentEl"), n = f();
    e({ el: o });
    ...
    return Ke(() => {
      ...
      const T = Z("back"), N = Z("panel-options-menu"), F = Z("left"), te = Z("right"), Qe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), Gt = k("truncate"), Ut = k("focus-item"), S = k("tippy");
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Oa, [
          ne(T, {
            class: ie(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => s.panel.close())
          }, null, 8, ["class"]),
          M((v(), A("h2", ka, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), A("div", Ma, U(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          ...
          m("div", {
            class: ie(s.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            s.panel.teleport ? V("", !0) : (v(), A("div", Pa, [
              d.value ? (v(), W(F, {
                key: 0,
...
}), Ga = { class: "relative" }, Ua = ["content", "aria-label"], Va = ["transform"], Ba = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), A("div", Ga, [
        M((v(), A("button", {
          type: "button",
          class: ie(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
...
}), za = { class: "relative" }, qa = ["content", "aria-label"], ja = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Wa = { class: "relative" }, Ha = ["content", "aria-label"], Ya = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Ja = { class: "w-32 h-32" }, Ka = ["content", "aria-label"], Za = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), eo = { class: "relative" }, to = ["content", "aria-label"], io = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), A("div", eo, [
        M((v(), A("button", {
          type: "button",
          class: ie(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": s.active }]),
...
}), so = { class: "relative" }, ro = ["content", "aria-label"], ao = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), oo = { class: "relative" }, no = ["content", "aria-label"], lo = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), uo = /* @__PURE__ */ Ne(co, [["__scopeId", "data-v-51e22a4a"]]), po = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, a) => {
      ...
      return v(), W(o, {
        ...
        default: se(() => [
          I(t).isFullscreen ? (v(), A("svg", po, a[0] || (a[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, vo = ["content", "aria-label"], bo = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    return (e, t) => {
      ...
      return v(), A("div", go, [
        M((v(), A("button", {
          type: "button",
          class: ie(["w-full h-full default-focus-style", [
            s.showOutline ? "focus:outline focus:outline-2 focus:outline-blue-400 focus:absolute focus:z-50" : "focus:outline-none"
          ]]),
  ...
  class: "relative",
  tabindex: "-1"
}, Ao = ["aria-label", "content"], Eo = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), xo = /* @__PURE__ */ Ne(Eo, [["__scopeId", "data-v-1cb84ae1"]]), So = B("areas-of-interest", () => ({ areas: f([]) })), Io = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Ro {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = To[r], this.codeToProvince(t);
  }
}
function $o(s) {
  return new Ro(s);
...
async function ko(s, e) {
  let t, i;
  const r = /^[-+]?([1-8]?\d(\.\d+)?|90(\.0+)?)(\s*[,|;\s]\s*)[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)[*]$/, a = /^\d{2,3}[A-P]/, o = /^[ABCEGHJKLMNPRSTVXY]\d[A-Z]/;
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await No(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await Fo(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await Do(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Go(t)), t;
}
const ri = async (s) => {
  ...
  const e = s.config;
  if (await Mo(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
}, Uo = "~FSA~", xi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Si = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ti {
  config;
  constructor(e, t) {
    let i, r, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${w}%3D'${Uo}'&outFields=${w}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y;
   ...
   */
  async query(e) {
    const t = await ko(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
const Vo = B("geosearch", () => {
  const s = f(new Ti("en", void 0)), e = f({
    ...
    () => new Promise((T) => {
      s.value.fetchTypes().then((N) => {
        N.sort(
          (F, te) => F.name.localeCompare(te.name, void 0, { sensitivity: "case" })
        ), T(N);
      });
    })
  );
  ...
  function g(T) {
    ...
    if (!N)
      ...
      const F = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(F), s.value.query(`${N}*`).then((te) => {
          c.value = te.failedServs, a.value = N, l.value = te.results;
          const Qe = Li(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
...
class is extends J {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = He.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new H(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
class De extends is {
   ...
   */
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      const i = this.symbologyStack.filter((a) => a.lastVisbility === !0).map((a) => a.definitionClause || "");
      let r = "";
      i.length === 0 ? r = "1=2" : i.length < this.symbologyStack.length && (r = i.join(" OR ")), this.layer.setSqlFilter(ae.SYMBOL, r);
    }
  }
  /**
...
var zo = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(zo || {});
class Ri extends is {
  _infoType;
...
var re = /* @__PURE__ */ ((s) => (s[s.UPLOAD = 0] = "UPLOAD", s[s.FORMAT = 1] = "FORMAT", s[s.CONFIGURE = 2] = "CONFIGURE", s))(re || {});
const Ko = B("wizard", () => {
  const s = {
    id: "Placeholder",
    layerType: x.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      case re.UPLOAD:
        c === re.UPLOAD ? t.value = "" : c === re.FORMAT && (l.value = re.FORMAT);
        break;
      case re.FORMAT:
        c === re.UPLOAD ? (a.value && (t.value = "", a.value = null), i.value = "", l.value = re.UPLOAD) : c === re.CONFIGURE && (l.value = re.CONFIGURE);
        break;
      case re.CONFIGURE:
        c === re.UPLOAD ? (t.value = "", i.value = "", a.value = null, r.value = !0, o.value = {
          config: s,
          configOptions: []
        }, l.value = re.UPLOAD) : c === re.FORMAT && (o.value = {
          config: s,
          configOptions: []
        }, r.value = !0, l.value = re.FORMAT);
        break;
    }
  }
  return {
...
class Zo {
  ...
  constructor(e, t, i) {
    ...
    const r = Xo(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Yn(this), this.panel = new Jn(this), this.geo = new Wn(this), this.dev = new tl(this), this.ui = {
   ...
   */
  initialize(e, t, i) {
    const r = pe(this.$vApp.$pinia), a = Je(this.$vApp.$pinia), o = Ct(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = rt(this.$vApp.$pinia), r = Le(this.$vApp.$pinia), a = pe(this.$vApp.$pinia), o = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "extentguard":
          return _o(this.$vApp.$pinia);
        case "geosearch":
          return Vo(this.$vApp.$pinia);
        case "grid":
   ...
   */
  get started() {
    return rt(this.$vApp.$pinia).started;
  }
  /**
...
function Xo(s, e) {
  ...
  r.directive("focus-container", Sa), r.directive("focus-list", ba), r.directive("focus-item", Aa), r.directive("truncate", La), r.component("panel-screen", Da), r.component("pin", Ba), r.component("close", ja), r.component("back", Ya), r.component("expand", Qa), r.component("panel-options-menu", uo), r.component("dropdown-menu", ii), r.component("minimize", io), r.component("right", ao), r.component("left", lo), r.component("fullscreen-nav-button", fo), r.component("geolocator-nav-button", mo), r.component("home-nav-button", yo), r.component("mapnav-button", bo), r.component("appbar-button", xo), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || He.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class Qo extends J {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = Q(await C.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class sn extends Qo {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new en(e), this.caption = new tn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  createMouseMoveHandler() {
    ...
    return st(this.mapMouseThrottle, (e) => {
...
const rn = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, an = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, on = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, nn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, ln = {
  circlePoint: rn,
  solidLine: an,
  outlinedPoly: on,
  boundingBoxPoly: nn
...
class fn extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    un(e);
    const l = e.features[0].geometry.type, n = cn[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(ln[n])
    );
    if (t) {
...
class gn extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new fn(e), this.ogc = new yn(e);
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Ae(Be(e, { query: { f: "json" } }));
    if (!i)
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? G.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (a.dataFormat = ee.ESRI_FEATURE, a.displayField = r.displayField || "", Array.isArray(r.fields)) {
...
class ss extends li {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = he.UNKNOWN;
...
class qe extends ss {
  ...
  async onInitiate() {
    ...
    this.esriWatches.push(
      ...
      this.esriView = Q(e.layerView), this.esriWatches.push(
        be(
  ...
  async terminate() {
    this.esriWatches.forEach((e) => e.remove()), this.esriWatches = [], this.esriLayer = void 0, await super.terminate(), this.viewDefProm = new H();
  }
  async reload() {
    if (!this.$iApi.geo.map.esriMap) {
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ns(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        const r = e?.customRenderer?.type ? e.customRenderer : Object.prototype.toString.call(e?.customRenderer) === "[object Function]" ? e.customRenderer(i.renderer) : Object.prototype.toString.call(e?.customRenderer) === "[object AsyncFunction]" ? await e.customRenderer(i.renderer) : i.renderer;
...
class vn extends qe {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = he.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class bn extends vn {
  ...
  async onInitiate() {
    this.esriLayer = Q(await C.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Xe extends ci {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = he.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = Q(await C.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = a.then(async () => {
      ...
      o.forEach((n) => {
        i.items.push(vt.makeRawItem(lt.ESRI, n.attributes));
      }), l.forEach((n) => {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Gn(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class _n extends ci {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = he.FEATURE, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async onInitiate() {
    Q(this.esriLayer = await C.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ae.PERMANENT)).then((n) => {
...
class Tn extends qe {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = x.MAPIMAGE, this.layerFormat = he.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new Ln(
          {
...
class Ln extends ci {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = he.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class Rn extends qe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = he.OSM, this.dataFormat = ee.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class $n extends qe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = he.IMAGERY, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Cn extends qe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERYTILE, this.layerFormat = he.IMAGERYTILE, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    const e = super.onLoadActions();
    return this.layerTree.name = this.name, e;
  }
}
class On extends qe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = he.TILE, this.dataFormat = ee.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class kn extends qe {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = he.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = Q(await C.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let a = !0, o;
        typeof r != "string" ? o = lt.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? o = lt.TEXT : (a = !1, o = lt.UNKNOWN), a && i.items.push(vt.makeRawItem(o, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(b).forEach((T) => l[T] = b[T]), Be(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class rs extends ss {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = he.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new as(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Un(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Nn extends rs {
  ...
  onLoadActions() {
    ...
    }), o = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ae.PERMANENT)).then((l) => {
...
class Dn extends J {
  ...
  async generateTabularAttributesWorker(e, t) {
    if (e.dataFormat === ee.ESRI_RASTER)
...
class qn extends J {
  ...
  async generateWMSSymbology(e) {
    const t = it(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), i = {
      svgcode: "",
      imgHeight: "",
      imgWidth: ""
    };
  ...
  async renderSymbologyImage(e, t = null) {
    t === null && (t = it(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0));
  ...
  async renderSymbologyIcon(e, t = null) {
    if (t === null) {
      ...
      a.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(a), t = it(a).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    }
  ...
  generatePlaceholderSymbology(e, t = "#000") {
    const i = it(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
  ...
  async generateBlankSymbology() {
    return it(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).svg();
  }
  /**
  ...
  async symbolToSvg(e) {
    ...
    const a = it(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: y }) {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, a] = await Ae(Be(`${e}/legend`, t));
...
class Wn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = He.geom, this.proj = He.proj, this.shared = He.sharedUtils, this.map = new sn(e), this.layer = new gn(e), this.attributes = new Dn(e), this.query = new jn(e), this.symbology = new qn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Hn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BOhwzEst.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Bx-ISuTu.js"), "../fixtures/basemap/index.ts": () => import("./index-DvzA7YQJ.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BmAvhbPv.js"), "../fixtures/details/index.ts": () => import("./index-DHOC3F1I.js"), "../fixtures/draw/index.ts": () => import("./index-DFdK6yoQ.js"), "../fixtures/export-footnote/index.ts": () => import("./index-jzzRGJKN.js"), "../fixtures/export-legend/index.ts": () => import("./index-XObR_l9p.js"), "../fixtures/export-map/index.ts": () => import("./index-C59uwkWp.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-BWehNCt6.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-BovjKXgK.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CwzPRgh8.js"), "../fixtures/export-title/index.ts": () => import("./index-DYpURki7.js"), "../fixtures/export/index.ts": () => import("./index-cYD0jMoR.js"), "../fixtures/extentguard/index.ts": () => import("./index-BlZNzvFT.js"), "../fixtures/gazebo/index.ts": () => import("./index-B_G1ANg8.js"), "../fixtures/geosearch/index.ts": () => import("./index-VLgt4jOe.js"), "../fixtures/grid/index.ts": () => import("./index-ou2iqcX4.js"), "../fixtures/help/index.ts": () => import("./index-Abuj-Af3.js"), "../fixtures/hilight/index.ts": () => import("./index-BgclPtY_.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DjNynfN7.js"), "../fixtures/legend/index.ts": () => import("./index-DomhVI1u.js"), "../fixtures/mapnav/index.ts": () => import("./index-BUqS_xLy.js"), "../fixtures/metadata/index.ts": () => import("./index-Bv3zQLlY.js"), "../fixtures/northarrow/index.ts": () => import("./index-bh8uKTO5.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CXuzUr9H.js"), "../fixtures/panguard/index.ts": () => import("./index-DbXR74_Z.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DHBi1ylx.js"), "../fixtures/settings/index.ts": () => import("./index-684l5bgZ.js"), "../fixtures/snowman/index.ts": () => import("./index-z7ekUBMt.js"), "../fixtures/swipe/index.ts": () => import("./index-CIPT66-I.js"), "../fixtures/wizard/index.ts": () => import("./index-CPkUAobJ.js") });
class Yn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const r = (await Hn[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
...
class di extends J {
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = Je(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((r) => {
...
const Qn = /* @__PURE__ */ Ne(Zn, [["render", Xn], ["__scopeId", "data-v-a3c61802"]]), el = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-CVHcwneg.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CYJKNQcH.js"), "../fixtures/export/screen.vue": () => import("./screen-B9T1Y6Kv.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-pB2aSot5.js"), "../fixtures/grid/screen.vue": () => import("./screen-CrAkDg7e.js"), "../fixtures/help/screen.vue": () => import("./screen-BSDVjG9a.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CZcT2B8b.js"), "../fixtures/legend/screen.vue": () => import("./screen-CdCRJ8yk.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DSEm0tkv.js"), "../fixtures/settings/screen.vue": () => import("./screen-DZjVfJxy.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DOhAPupC.js") });
class St extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (js(t) || qs(t))
      ...
      let r;
      typeof t == "string" ? r = el[`../fixtures/${t}`]() : r = t();
...
function sl(s) {
  ...
  return al(s.services, e), rl(s.map, e), ol(s.ui, e), s.plugins && nl(s.plugins, e), e;
}
function rl(s, e) {
...
function Wt(s) {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), ll(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var at = { major: "4", minor: "14", patch: "0-beta", timestamp: "Wed Oct 22 21:47:40 2025 -0500", hash: "f6f2ee8e35eaa6e7e6f55bf8e7b873884937890b" };
console.info(
  `RAMP v${at.major}.${at.minor}.${at.patch} [${at.hash.slice(0, 9)}] (Built on ${new Date(
...
const Jl = (s, e, t) => new Zo(s, e, t), He = new zs();
export {
  H as $,
  Gr as A,
  yt as B,
