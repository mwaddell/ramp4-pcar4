import{a9 as dt,v as z,ah as $,af as pt,cI as ft,da as ht,dz as gt}from"./main-DclqjhjV.js";import{o as mt}from"./floatRGBA-B3css21J.js";import{e as me,a as vt,r as St,u as Re,n as ne}from"./vec4f64-DD-nkcCV.js";import{a7 as xt,L as bt,ae as Ot,aP as Ct,s as Tt,H as Pt,M as At,a9 as zt,o as yt,R as Fe,ad as ve,c as Ie,I as we,w as Et,aQ as Rt,i as Ft,D as V,k as It,e as wt,K as Dt,aH as te,V as _t,W as Mt,al as Lt,aR as jt,as as Nt,O as Ut,at as Bt,au as y,av as $t,aw as X,t as Vt,aS as De,aT as _e,aU as qt,ai as Ht,aV as Gt,ay as Wt,aC as Xt,aW as Qt,aX as kt,aY as Zt,aZ as Yt,a_ as Me,a$ as Le,b0 as Kt,aD as Jt,b1 as je}from"./OutputColorHighlightOID.glsl-BepTPYs7.js";import{P as Ne,R as Ue,C as eo}from"./enums-wEDHPbCF.js";import{n as Be}from"./mat3-DOnW3DjW.js";import{e as $e}from"./mat3f64-BnNZDR5l.js";import{h as Ve}from"./mat4-CAR5IBrn.js";import{e as to}from"./mat4f64-xsZDPPj0.js";import{r as oo,o as Se,I as io}from"./vec2-BnynUbeJ.js";import{n as xe,r as qe}from"./vec2f64-CkowXrDb.js";import{o as le,E as Q,A as be,c as He,g as q,s as G,r as oe,p as Ge,u as Oe,R as so,N as ao,P as ro}from"./vec32-C1qyn8pW.js";import{s as no,g as lo,o as We,f as co,y as uo,T as Xe}from"./BufferView-7E-BDxyv.js";import{O as po}from"./InterleavedLayout-BLdLLa68.js";import{n as B,u as Qe,w as Ce}from"./ShaderOutput-CUn9tpiG.js";import{l as ke,u as fo,n as ho,b as go,d as mo}from"./dehydratedFeatureUtils-Bxrv3-Fp.js";import{e as d}from"./VertexAttribute-hUz6pozM.js";import{B as vo,o as So,g as xo,p as bo}from"./renderState-BM-MCKUz.js";import{n as p,t as R}from"./glsl-Z5uYj8ka.js";import{a as Oo}from"./BindType-CKbZk6AG.js";import"./vec42-D8CJyqHG.js";import{i as Co}from"./ShaderBuilder-C3i3-Xc9.js";let To=class extends xt{constructor(e,t){super(e,"vec4",Oo.Draw,(o,i,s)=>o.setUniform4fv(e,t(i,s)))}};const ce=128,H=.5,Po=me(H/2,H/2,1-H/2,1-H/2);function Ao(e){return e==="cross"||e==="x"}function zo(e,t=ce,o=t*H,i=0){const{data:s,parameters:r}=Ze(e,t,o,i);return new bt(s,r)}function Ze(e,t=ce,o=t*H,i=0){return{data:yo(e,t,o,i),parameters:{mipmap:!1,wrap:{s:Ne.CLAMP_TO_EDGE,t:Ne.CLAMP_TO_EDGE},width:t,height:t,components:4,noUnpackFlip:!0,reloadable:!0}}}function yo(e,t=ce,o=t*H,i=0){switch(e){case"circle":default:return Eo(t,o);case"square":return Ro(t,o);case"cross":return Io(t,o,i);case"x":return wo(t,o,i);case"kite":return Fo(t,o);case"triangle":return Do(t,o);case"arrow":return _o(t,o)}}function Eo(e,t){const o=e/2-.5;return ie(e,Je(o,o,t/2))}function Ro(e,t){return Ye(e,t,!1)}function Fo(e,t){return Ye(e,t,!0)}function Io(e,t,o=0){return Ke(e,t,!1,o)}function wo(e,t,o=0){return Ke(e,t,!0,o)}function Do(e,t){return ie(e,et(e/2,t,t/2))}function _o(e,t){const o=t,i=t/2,s=e/2,r=.8*o,a=Je(s,(e-t)/2-r,Math.sqrt(r*r+i*i)),c=et(s,o,i);return ie(e,(l,n)=>Math.max(c(l,n),-a(l,n)))}function Ye(e,t,o){return o&&(t/=Math.SQRT2),ie(e,(i,s)=>{let r=i-.5*e+.25,a=.5*e-s-.75;if(o){const c=(r+a)/Math.SQRT2;a=(a-r)/Math.SQRT2,r=c}return Math.max(Math.abs(r),Math.abs(a))-.5*t})}function Ke(e,t,o,i=0){t-=i,o&&(t*=Math.SQRT2);const s=.5*t;return ie(e,(r,a)=>{let c,l=r-.5*e,n=.5*e-a-1;if(o){const f=(l+n)/Math.SQRT2;n=(n-l)/Math.SQRT2,l=f}return l=Math.abs(l),n=Math.abs(n),c=l>n?l>s?Math.sqrt((l-s)*(l-s)+n*n):n:n>s?Math.sqrt(l*l+(n-s)*(n-s)):l,c-=i/2,c})}function Je(e,t,o){return(i,s)=>{const r=i-e,a=s-t;return Math.sqrt(r*r+a*a)-o}}function et(e,t,o){const i=Math.sqrt(t*t+o*o);return(s,r)=>{const a=Math.abs(s-e)-o,c=r-e+t/2+.75,l=(t*a+o*c)/i,n=-c;return Math.max(l,n)}}function ie(e,t){const o=new Uint8Array(4*e*e);for(let i=0;i<e;i++)for(let s=0;s<e;s++){const r=s+e*i;let a=t(s,i);a=a/e+.5,mt(a,o,4*r)}return o}function Mo(e){return e instanceof Float32Array&&e.length>=16}function Lo(e){return Array.isArray(e)&&e.length>=16}function jo(e){return Mo(e)||Lo(e)}class No{constructor(){this.factor=new tt,this.factorAlignment=new tt}}class tt{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function Uo(e,t){const{vertex:o,fragment:i}=e;e.include(Ot,t),o.include(ke),o.main.add(p`vec4 posProjCenter;
...
fragColor.g = 0.5;
}`)}function ot(e){const t=new Co,{signedDistanceFieldEnabled:o,occlusionTestEnabled:i,horizonCullingEnabled:s,pixelSnappingEnabled:r,hasScreenSizePerspective:a,debugDrawLabelBorder:c,vvSize:l,vvColor:n,hasRotation:f,occludedFragmentFade:v,sampleSignedDistanceFieldTexelCenter:g}=e;t.include(fo,e),t.vertex.include(Ct,e);const{occlusionPass:P,output:I,oitPass:A}=e;if(P)return t.include(Uo,e),t;const{vertex:x,fragment:O}=t;t.include(Tt),t.include(Pt,e),t.include(At,e),i&&t.include(ho),O.include(go),O.include(zt),t.varyings.add("vcolor","vec4"),t.varyings.add("vtc","vec2"),t.varyings.add("vsize","vec2");const C=I===B.Highlight,w=C&&i;w&&t.varyings.add("voccluded","float"),x.uniforms.add(new yt("viewport",u=>u.camera.fullViewport),new Fe("screenOffset",(u,L)=>Se(ue,2*u.screenOffset[0]*L.camera.pixelRatio,2*u.screenOffset[1]*L.camera.pixelRatio)),new Fe("anchorPosition",u=>k(u)),new ve("materialColor",u=>u.color),new Ie("materialRotation",u=>u.rotation),new we("tex",u=>u.texture)),Et(x),o&&(x.uniforms.add(new ve("outlineColor",u=>u.outlineColor)),O.uniforms.add(new ve("outlineColor",u=>it(u)?u.outlineColor:vt),new Ie("outlineSize",u=>it(u)?u.outlineSize:0))),s&&x.uniforms.add(new To("pointDistanceSphere",(u,L)=>{const M=L.camera.eye,_=u.origin;return St(_[0]-M[0],_[1]-M[1],_[2]-M[2],dt.radius)})),r&&x.include(ke),a&&(Rt(x),Ft(x)),c&&t.varyings.add("debugBorderCoords","vec4"),t.attributes.add(d.UVI,"vec2"),t.attributes.add(d.COLOR,"vec4"),t.attributes.add(d.SIZE,"vec2"),t.attributes.add(d.ROTATION,"float"),(l||n)&&t.attributes.add(d.FEATUREATTRIBUTE,"vec4"),x.code.add(s?p`bool behindHorizon(vec3 posModel) {
...
return b > 0.0 && b < a && b * b  > a * c;
    ...
    ${R(w,p`voccluded = visible ? 0.0 : 1.0;`)}
  `);const F=p`
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
    ...
    ${R(I===B.ObjectAndLayerIdColor,p`vcolor.a = 1.0;`)}
    ...
    vsize = inputSize;
  `),O.uniforms.add(new we("tex",u=>u.texture)),v&&!C&&O.uniforms.add(new It("depthMap",u=>u.mainDepth),new wt("occludedOpacity",u=>u.hudOccludedFragmentOpacity));const N=c?p`(isBorder > 0.0 ? 0.0 : ${p.float(V)})`:p.float(V),D=p`
  ...
  `;switch(I){case B.Color:case B.ColorEmission:t.outputs.add("fragColor","vec4",0),I===B.ColorEmission&&t.outputs.add("fragEmission","vec4",1),A===te.ColorAlpha&&t.outputs.add("fragAlpha","float",I===B.ColorEmission?2:1),O.main.add(p`
        ${D}
        ${R(A===te.FrontFace,p`fragColor.rgb /= fragColor.a;`)}
        ${R(I===B.ColorEmission,p`fragEmission = vec4(0.0);`)}
